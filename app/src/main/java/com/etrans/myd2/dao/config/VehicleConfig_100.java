...
public class VehicleConfig_100 extends BaseVehicleConfig {
	// 登陆
	...
	/** 急加速_最小值 */
	public static final int GREET_ACC_VALUE = 23000;
	/** 起车_急加速 */
	public static final int STARTCAR_ACC_VALUE = 32000;
	/** 只计起车_急加速的起始速度值 */
	public static final int STARTCAR_DIA_SPEED = 15;
	/** 急减速_最小值 */
	public static final int TINY_ACC_VALUE = -57000;
	/** 稳定驾驶_统计最小时间单位 */
	...
	/** 畅快驾驶_下值 */
	public static final int STEAD_DOWN_VALUE = 30;
	 ...
	 * 统计数据所有字段
	 */
	public static final String[] staProjection = {
			CANContentConst.VehicleStatisticsStates.DAY,// 日期
			...
			CANContentConst.VehicleStatisticsStates.DRIVE_DISTANCE,// 行车里程
			CANContentConst.VehicleStatisticsStates.AVERAGE_SPEED,// 平均车速
			CANContentConst.VehicleStatisticsStates.KILO_CONSUME ,// 百公里耗电
			CANContentConst.VehicleStatisticsStates.CHARGE_COUNTS // 充电次数
	};
	/**
	 * 基础数据所有字段
	 */
	public static final String[] baseProjection = {
			...
			CANContentConst.VehicleBasicStates.DRIVE_RANGE,// 剩余行驶里程
			CANContentConst.VehicleBasicStates.LEFT_DOOR,
			CANContentConst.VehicleBasicStates.RIGHT_DOOR,
			CANContentConst.VehicleBasicStates.LEFT_WINDOW,
			CANContentConst.VehicleBasicStates.RIGHT_WINDOW,
